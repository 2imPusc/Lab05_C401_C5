...
# Prototype — Hệ thống hỗ trợ cứu hộ cho xe điện VinFast
...
- 1 flow chính chạy thật: **nhập mô tả sự cố xe → nhận chẩn đoán hoặc gợi ý phương án cứu hộ → yêu cầu gọi cứu hộ → Tìm thông tin trạm cứu hộ, ước tính chi phí → người dùng xác nhận**
...
| ---------- | ----------------------------- | --------------------------- |
| Phúc       | slides, lead nhóm             | dem-slides.pdf, sản phẩm    |
| Khánh Nam  | Sketch                        | Prototype, sản phẩm         |
