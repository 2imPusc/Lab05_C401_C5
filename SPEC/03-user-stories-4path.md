...
| **Low-confidence** | System báo bằng cách nào? | User miêu tả "Xe có tiếng kêu cộc cộc lạ ở gầm". AI không thể xác định chính xác bệnh (confidence 40%). AI phản hồi: "Dựa trên mô tả, có thể do kẹt dị vật ở phanh hoặc lỗi thước lái. *Vì lý do an toàn, tôi không thể tự chẩn đoán chắc chắn.*" → Tự động hiện khung chat trực tiếp / nút gọi nối máy thẳng với Kỹ thuật viên chuyên môn. |
...
- Failure → Bỏ dùng: AI chẩn đoán sai 2 lần liên tiếp, hỏi đi hỏi lại những câu không cần thiết → User hoảng loạn, tắt App và gọi thẳng số Hotline tổng đài.
...
|------------------------|------------------------------|------------------------|
| **User hoảng loạn, nhắn tin chửi thề / không rõ nghĩa** (VD: "Xe tự nhiên hỏng rồi làm sao đây!!!") | Ai giúp tránh những cuộc tranh cãi với tổng đài. | Tạm ngưng luồng hỏi đáp dài dòng. UI lập tức đổi màu cảnh báo (Đỏ), hiện nút bấm to `[Gọi SOS Khẩn Cấp]` và tự động đính kèm vị trí GPS. |
...
* **Trả lời:** CÓ. Tâm lý và sự quen thuộc với hệ thống của hai nhóm này khác nhau:
    * **User mới:** Ở *Happy path*, hệ thống cần giải thích rõ ràng hơn về cách AI suy luận để xây dựng lòng tin (Trust). Ở *Low-confidence* hoặc *Failure path*, nút gọi cứu hộ/tổng đài viên phải cực kỳ nổi bật để họ có cảm giác an toàn (Safety net).
